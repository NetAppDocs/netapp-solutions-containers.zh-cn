...
. 安装 F5 Application Services 3 扩展，以允许 BIG-IP 系统接受 JSON 格式的配置，而不是命令式命令。转到 link:https://github.com/F5Networks/f5-appsvcs-extension/releases["F5 AS3 GitHub 存储库"^]，然后下载最新的 RPM 文件。

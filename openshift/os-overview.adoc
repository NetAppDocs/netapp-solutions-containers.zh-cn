...
. 按照 Red Hat 提供的 link:https://docs.openshift.com/container-platform/4.7/installing/index.html["安装说明"^] 部署到您选择的环境。
...
* link:os-on-bm.html["裸机上的 OpenShift"]
* link:os-on-openstack.html["Red Hat OpenStack 平台上的 OpenShift"]
* link:os-on-rhv.html["Red Hat 虚拟化上的 OpenShift"]

...
* link:https://portal.aws.amazon.com/billing/signup["AWS 账户"^]
* link:https://console.redhat.com/["Red Hat 帐户"^]
* IAM 用户 link:https://www.rosaworkshop.io/rosa/1-account_setup/["具有适当的权限"^] 用于创建和访问 ROSA 集群
* link:https://aws.amazon.com/cli/["AWS CLI"^]
* link:https://console.redhat.com/openshift/downloads["ROSA CLI"^]
* link:https://console.redhat.com/openshift/downloads["OpenShift 命令行界面"^] (oc)
* Helm 3 link:https://docs.aws.amazon.com/eks/latest/userguide/helm.html["文档"^]
...
使用 node-prep 标志并安装 Trident，如图所示。在发出 install 命令之前，应已下载安装程序包。请参阅 link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package["下载 Trident 安装程序包"^]。
...
Trident 后端配置告诉 Trident 如何与存储系统（在本例中为 FSx for ONTAP）进行通信。为了创建后端，我们将提供要连接的存储虚拟机的凭据，以及集群管理和 NFS 数据接口。我们将使用link:https://docs.netapp.com/us-en/trident/trident-use/ontap-nas.html["ontap-nas驱动程序"^]在 FSx 文件系统中配置存储卷。
...
image::redhat-openshift-container-rosa-017.png[postgresql 表、架构、行]

...
有关安装和配置详细信息，请参阅 link:https://docs.netapp.com/us-en/trident/index.html["Trident产品文档"^]。
...
. 将安装存档下载到管理工作站并解压缩内容。当前版本的 Trident 可以从 link:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Trident 在 GitHub 上的发布页面"^] 下载。
. 从下载的软件包中提取Trident安装。
+
[listing]
----
